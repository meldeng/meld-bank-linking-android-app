...
open class Resource<T, F> private constructor(
    ...
    companion object {
        ...
        /**
         * Creates a new resource with the loading more state and the given data
         * @param data Excepts the data of the given type T (Optional)
         * @return Resource object with state loading
         */
        fun <T, F> loadingMore(data: T? = null) =
            Resource<T, F>(state = State.LOADING_MORE, data = data)
         ...
         * @return Resource object with state error
         */
        fun <T, F> error(errorData: F? = null, data : T? =null) =
            Resource(state = State.ERROR, data = data, exception = null, errorData = errorData)


        /**
         * Creates the new resource with the cancel state and message
         * You can optionally pass the data and throwable too
         * @param data Excepts the data of the given type T (Optional)
         * @param throwable The error object (Optional)
         * @return Resource object with state error
         */
        fun <T, F> cancel(data: T? = null, throwable: Throwable? = null, errorData: F? = null) =
            Resource(
                state = State.CANCEL,
                data = data,
                exception = throwable,
    ...
    enum class State { NONE, LOADING, SUCCESS, ERROR, CANCEL, LOADING_MORE }
}
